        ...
        <>
            <div className='md:flex md:justify-between items-center gap-5 md:gap-0 py-5 md:px-20 px-10 h-fit sticky md:-top-10 bg-[#393E46] text-[#00ADB5]'>
                <div className='flex justify-between items-center'>
                    <h2 className="text-center md:text-5xl text-2xl font-bold tracking-widest">RH</h2>
                ...
                <ul className={`md:flex md:flex-row gap-5 items-center lg:gap-20 md:gap-10 md:text-xl text-sm font-medium transition-all  duration-500
                    ${isClick ? 'flex flex-col absolute top-20 left-0 w-full ease-in-out pb-5 bg-[#393E46] z-50' : 'hidden'}
                `}>
